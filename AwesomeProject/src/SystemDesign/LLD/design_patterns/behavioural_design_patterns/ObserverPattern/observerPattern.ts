...
const observer1: INotificationAlertObserver =
  new EmailNotificationAlertObserver(iphoneStockObservable, 'test@gmial.com');
...
const observer2: INotificationAlertObserver = new SMSNotificationAlertObserver(
